...
import "./interfaces/IQubeStableSwapLP.sol";
import "./interfaces/IQubeStableSwapDeployer.sol";
import "./interfaces/IQubeStableSwapLPFactory.sol";

contract QubeStableSwapFactory is Ownable {
    ...
    IQubeStableSwapLPFactory public immutable LPFactory;
    IQubeStableSwapDeployer public immutable SwapTwoPoolDeployer;
    IQubeStableSwapDeployer public immutable SwapThreePoolDeployer;
     ...
     */
    constructor(
        IQubeStableSwapLPFactory _LPFactory,
        IQubeStableSwapDeployer _SwapTwoPoolDeployer,
        IQubeStableSwapDeployer _SwapThreePoolDeployer
    ) {
    ...
    function createSwapPair(
        ...
        IQubeStableSwapLP(LP).setMinter(swapContract);
    ...
    function addPairInfo(address _swapContract) external onlyOwner {
        IQubeStableSwap swap = IQubeStableSwap(_swapContract);
