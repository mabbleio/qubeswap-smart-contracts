...
import "./QubeStableSwapThreePool.sol";

contract QubeStableSwapThreePoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(QubeStableSwapThreePool).creationCode;
        ...
        QubeStableSwapThreePool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
