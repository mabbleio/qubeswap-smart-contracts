...
import "./QubeStableSwapLP.sol";

contract QubeStableSwapLPFactory is Ownable {
    ...
    function createSwapLP(
        ...
        // create LP token
        bytes memory bytecode = type(QubeStableSwapLP).creationCode;
        ...
        QubeStableSwapLP(lpToken).setMinter(_minter);
