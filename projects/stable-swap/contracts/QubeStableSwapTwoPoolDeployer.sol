...
import "./QubeStableSwapTwoPool.sol";

contract QubeStableSwapTwoPoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(QubeStableSwapTwoPool).creationCode;
        ...
        QubeStableSwapTwoPool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
