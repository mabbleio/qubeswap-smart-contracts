...
const Factory = artifacts.require("QubeStableSwapFactory");
const StableSwapTwoPool = artifacts.require("QubeStableSwapTwoPool");
const LPToken = artifacts.require("QubeStableSwapLP");
const Token = artifacts.require("./test/Token.sol");
const QubeStableSwapInfo = artifacts.require("./utils/QubeStableSwapInfo.sol");
const QubeStableSwapTwoPoolInfo = artifacts.require("./utils/QubeStableSwapTwoPoolInfo.sol");
const QubeStableSwapThreePoolInfo = artifacts.require("./utils/QubeStableSwapThreePoolInfo.sol");
const QubeStableSwapLPFactory = artifacts.require("QubeStableSwapLPFactory.sol");
const QubeStableSwapTwoPoolDeployer = artifacts.require("QubeStableSwapTwoPoolDeployer.sol");
const QubeStableSwapThreePoolDeployer = artifacts.require("QubeStableSwapThreePoolDeployer.sol");

contract("QubeStableSwapTwoPool", ([admin, user1, user2, admin2, user3, user4]) => {
  let factory,
    swapDeployer,
  ...
  beforeEach(async () => {
    LPFactory = await QubeStableSwapLPFactory.new({ from: admin });
    swapDeployer = await QubeStableSwapTwoPoolDeployer.new({ from: admin });
    swapTriplePoolDeployer = await QubeStableSwapThreePoolDeployer.new({ from: admin });
    ...
    threePoolInfoSC = await QubeStableSwapThreePoolInfo.new({ from: admin });
    twoPoolInfoSC = await QubeStableSwapTwoPoolInfo.new({ from: admin });
    poolInfoSC = await QubeStableSwapInfo.new(twoPoolInfoSC.address, threePoolInfoSC.address, { from: admin });
  });
  ...
  describe("Add pair info", () => {
    ...
    beforeEach(async () => {
      let LPFactory2 = await QubeStableSwapLPFactory.new({ from: admin });
      let swapDeployer2 = await QubeStableSwapTwoPoolDeployer.new({ from: admin });
      let swapTriplePoolDeployer2 = await QubeStableSwapThreePoolDeployer.new({ from: admin });
