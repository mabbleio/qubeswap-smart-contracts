...
const QubeStableSwapTwoPool = artifacts.require("QubeStableSwapTwoPool");
...
contract("QubeStableSwapTwoPool", ([admin, user1, user2]) => {
  let factory,
    swapDeployer,
  ...
  beforeEach(async () => {
    ...
    swap_BNB_WBNB = await QubeStableSwapTwoPool.at(info.swapContract);
