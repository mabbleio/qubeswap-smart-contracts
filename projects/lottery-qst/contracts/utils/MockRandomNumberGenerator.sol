...
contract MockRandomNumberGenerator is IRandomNumberGenerator, Ownable {
    address public qubeSwapLottery;
    ...
    /**
     * @notice Set the address for the QubeSwapLottery
     * @param _qubeSwapLottery: address of the QubeSwap lottery
     */
    function setLotteryAddress(address _qubeSwapLottery) external onlyOwner {
        qubeSwapLottery = _qubeSwapLottery;
    }
     ...
     * @param _seed: seed provided by the QubeSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == qubeSwapLottery, "Only QubeSwapLottery");
    ...
    function changeLatestLotteryId() external {
        latestLotteryId = IQubeSwapLottery(qubeSwapLottery).viewCurrentLotteryId();
    }
