...
contract VQst is Ownable {
    ...
    uint256 public MAX_LOCK = 365 days; // 365 days , set default same with qst pool.
        ...
        if (initialization[_user]) {
            ...
            if (cache.shares > 0) {
                if (cache.locked) {
                    ...
                    uint256 currentAmount = ((cache.qstPoolAvailable + totalBoostDebt) * (cache.shares)) /
                        totalShares -
                        cache.userBoostedShare;
                    ...
                    if (
                        ...
                        cache.qstPoolAvailable -= currentOverdueFee;
                    ...
                    if (totalShares != 0) {
                        currentShares =
                            ...
                            ((cache.qstPoolAvailable + totalBoostDebt) - currentAmount);
                    } else {
                    ...
                    uint256 totalAmount = (cache.shares * (cache.qstPoolAvailable + totalBoostDebt)) / totalShares;
                    totalShares -= cache.shares;
                    cache.shares = 0;
                    ...
                    if (currentPerformanceFee > 0) {
                        cache.qstPoolAvailable -= currentPerformanceFee;
                    ...
                    if (totalShares != 0) {
                        newShares =
                            ...
                            ((cache.qstPoolAvailable + totalBoostDebt) - totalAmount);
                    } else {
            ...
            if (cache.shares > 0 && cache.locked) {
                ...
                if (cache.lockStartTime == block.timestamp) {
                    cache.lockedAmount = ((cache.qstPoolAvailable + totalBoostDebt) * cache.shares) / totalShares;
                }
            }
