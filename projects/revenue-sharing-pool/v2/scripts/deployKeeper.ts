...
const main = async () => {
  ...
  if (networkName === "testnet" || networkName === "mainnet") {
    ...
    if (config.RevenueSharingPoolForQst_Two[networkName] === ethers.constants.AddressZero) {
    ...
    const contract = await RevenueSharingPoolKeeperContract.deploy(config.RevenueSharingPoolForQst_Two[networkName]);
