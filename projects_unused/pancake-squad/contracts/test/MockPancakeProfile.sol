 ...
 */
contract MockQubeProfile is AccessControl, ERC721Holder {
    ...
    uint256 public numberQstToReactivate;
    uint256 public numberQstToRegister;
    uint256 public numberQstToUpdate;
    ...
    constructor(
        IERC20 _qubeswapToken,
        uint256 _numberQstToReactivate,
        uint256 _numberQstToRegister,
        uint256 _numberQstToUpdate
    ) {
        qubeswapToken = _qubeswapToken;
        numberQstToReactivate = _numberQstToReactivate;
        numberQstToRegister = _numberQstToRegister;
        numberQstToUpdate = _numberQstToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends QST to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        qubeswapToken.safeTransferFrom(_msgSender(), address(this), numberQstToRegister);
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer QST token to this address
        qubeswapToken.safeTransferFrom(_msgSender(), address(this), numberQstToUpdate);
    ...
    function reactivateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        qubeswapToken.safeTransferFrom(_msgSender(), address(this), numberQstToReactivate);
    ...
    /**
     * @dev Update the number of QST to register
     * Callable only by owner admins.
     */
    function updateNumberQst(
        ...
        numberQstToReactivate = _newNumberQstToReactivate;
        numberQstToRegister = _newNumberQstToRegister;
        numberQstToUpdate = _newNumberQstToUpdate;
    }
