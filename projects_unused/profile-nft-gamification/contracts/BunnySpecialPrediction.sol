...
contract BunnySpecialPrediction is Ownable {
    ...
    BnbPricePrediction public qubePrediction;
    ...
    constructor(
        ...
        qubePrediction = BnbPricePrediction(_qubePrediction);
    ...
    function _canClaim(address _userAddress) internal view returns (bool) {
        if (hasClaimed[_userAddress]) {
            ...
            if (!qubeProfile.getUserStatus(_userAddress)) {
                ...
                (roundId, ) = qubePrediction.getUserRounds(_userAddress, 0, 1);
