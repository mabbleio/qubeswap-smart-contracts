...
contract PointCenterIFO is Ownable {
    ...
    constructor(address _qubeProfileAddress, uint256 _maxViewLength) public {
    ...
    function getPoints(address _contractAddress) external {
        ...
        bool isUserActive = qubeProfile.getUserStatus(senderAddress);
