...
contract TradingCompV3 is Ownable, ERC721Holder {
    ...
    IBEP20 public immutable qubeswapToken;
    ...
    struct CompetitionRewards {
        ...
        uint256[5] moboxRewards; // qst rewards per group
     ...
     */
    function claimQstRemainder(uint256 _amount) external onlyOwner {
    ...
    {
        bool isUserActive;
        (, , , , , isUserActive) = qubeProfile.getUserProfile(_userAddress);
        ...
        if ((currentStatus != CompetitionStatus.Claiming) && (currentStatus != CompetitionStatus.Over)) {
            ...
            return (
                ...
                userRewardGroup,
                compRewards.qstRewards[userRewardGroup],
