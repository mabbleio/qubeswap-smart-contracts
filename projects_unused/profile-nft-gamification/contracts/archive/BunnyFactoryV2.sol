...
contract BunnyFactoryV2 is Ownable {
    ...
    // Number of QSTs a user needs to pay to acquire a token
    ...
    function mintNFT(uint8 _bunnyId) external {
        ...
        // Send QST tokens to this contract
        qubeswapToken.safeTransferFrom(address(_msgSender()), address(this), tokenPrice);

        string memory tokenURI = bunnyIdURIs[_bunnyId];

        uint256 tokenId = qubeBunnies.mint(address(_msgSender()), tokenURI, _bunnyId);
    ...
    function setBunnyNames(
        ...
        qubeBunnies.setBunnyName(5, _bunnyId5);
        qubeBunnies.setBunnyName(6, _bunnyId6);
        qubeBunnies.setBunnyName(7, _bunnyId7);
        qubeBunnies.setBunnyName(8, _bunnyId8);
        qubeBunnies.setBunnyName(9, _bunnyId9);
    }
