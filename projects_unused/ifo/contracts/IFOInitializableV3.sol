...
import "profile-nft-gamification/contracts/QubeProfile.sol";

import "./interfaces/IIFOV2.sol";
import "qube-qst-vault/contracts/IFOPool.sol";
import "qube-qst-vault/contracts/test/QubeSwapToken.sol";
import "qube-qst-vault/contracts/test/SyrupBar.sol";
import "qube-qst-vault/contracts/test/MasterChef.sol";
...
contract IFOInitializableV3 is IIFOV2, ReentrancyGuard, Ownable {
     ...
     * @param _qubeProfileAddress: the address of the QubeProfile
    ...
    function depositPool(uint256 _amount, uint8 _pid) external override nonReentrant notContract {
        ...
        require(qubeProfile.getUserStatus(msg.sender), "Deposit: Must have an active profile");
